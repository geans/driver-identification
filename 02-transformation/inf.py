...
def dataset__this_car_is_mine(basein, baseout):
        ...
        for driver in driver_list:
            ...
            for series_length in range(60, 901, 60):
                for file_number in range(1,file_amount_list+1):
                    ...
                    directory_in =  f'{basein}/ThisCarIsMine/{driver}'
                    directory_out = f'{baseout}/{series_length}/ThisCarIsMine/{driver}'
...
if __name__ == '__main__':
    dataset__this_car_is_mine(
        basein='../01-dataset-raw', 
        baseout='../02-transformation/02.1-dataset-processed/multiprocessing'
    )